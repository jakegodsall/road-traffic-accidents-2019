...
\begin{figure}[h]
\centering     %%% not \center
\subfigure[Vehicle type by time of day.]{\label{fig:a-vehicle-hour}\includegraphics[width=0.80\textwidth]{vehicle_hour_plot}}
\subfigure[Vehicle type by day of the week.]{\label{fig:b-vehicle-day}\includegraphics[width=0.80\textwidth]{vehicle_day_plot}}
